...
/**
 * Helper methods for dealing with multiple Avro input schemas. A mapping is stored in the
...
public class AvroMultipleInputsUtil {
   ...
   *
   * @param conf
   *          configuration to get schema from
   * @param split
   *          input split to get schema for
   * @return schema
   */
   ...
   * @param path
   *          the path to set the schema for
   */
